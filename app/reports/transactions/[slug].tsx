...
const TITLE_MAP: Record<string, string> = {
  'semua-data': 'Semua Data Transaksi',
  'jual-produk': 'Transaksi Jual Produk',
  ditolak: 'Transaksi Ditolak/Dibatalkan',
  'faktur-ditagihkan': 'Faktur Yang Ditagihkan',
  'top-layanan': 'Top Layanan',
};
