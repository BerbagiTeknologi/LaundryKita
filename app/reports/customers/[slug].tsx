...
const TITLE_MAP: Record<string, string> = {
  pertumbuhan: 'Pertumbuhan Pelanggan',
  'top-pelanggan': 'Top Pelanggan',
  'riwayat-faktur': 'Faktur Pelanggan',
};
...
export default function CustomerReportDetail() {
  ...
  const isInvoice = params.slug === 'riwayat-faktur';
      ...
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        {isInvoice ? (
          <View style={styles.invoiceCard}>
            <Text style={styles.invoiceTitle}>Total Faktur Pelanggan</Text>
            <Text style={styles.invoiceValue}>0</Text>
          </View>
        ) : (
          <>
        ...
        <View style={[styles.emptyState, isInvoice && { marginTop: 20 }]}>
          <Image
